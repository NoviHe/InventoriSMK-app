...
@section('content_header')
    <h1>Kategori <small>Data</small></h1>
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="post" autocomplete="off" action="{{route('kategori.store')}}">
                    {{ csrf_field() }}
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_kategori" id="kode_kategori" value="{{$kode}}" readonly
                        class="form-control @error('nama_kategori') is-invalid @enderror">
                    </div>
                    <div class="form-group">
                ...
                <table class="table table-bordered" id="myTable">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            href="{{route('kategori.edit',$dt->id_kategori)}}"><i class="fa fa-edit"></i></a>
                            <button class="btn btn-sm btn-danger btn-trash" type="submit" data-id="{{$dt->id_kategori}}">
...
<div class="modal fade" id="modalHapus">
    <div class="modal-dialog">
        <div class="modal-content bg-danger">
            <form method="POST" id="form-delete" action="{{route('kategori.delete')}}">
