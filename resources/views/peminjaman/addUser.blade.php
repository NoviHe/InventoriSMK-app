...
@section('title','User Input Peminjaman')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-primary">
                ...
                <form action="{{route('pinjam.keranjang')}}" autocomplete="off" method="POST" class="form-horizontal" id="quickForm">
                {{ csrf_field() }}
                <div class="card-body">
                        <div class="col-md-12">
                            <h3>Data Barang</h3>
        ...
        <div class="col-md-6">
            <div class="card">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <div class="btn btn-group float-right">
                                ...
                                {{Session::forget('cart')}}
                                @else
                                <a href="{{route('pinjam.minOne',$item['items']['id_inventaris'])}}" 
                                class="badge bg-danger"> - </a> 
                                @endif
                                <span class=" badge bg-primary"> {{$item['qty']}}</span> 
                                <a href="{{route('pinjam.plusOne',$item['items']['id_inventaris'])}}" class="badge bg-danger"> + </a>
                            </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{route('checkoutUser')}}" type="button" class="btn btn-success float-right">Checkout</a>
                    @else 
